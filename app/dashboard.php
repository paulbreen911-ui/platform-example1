...
.live-banner {
  ...
  border: .5px solid rgba(232, 53, 10, 0.3);
  border-radius: 10px;
  padding: 14px 20px;
  margin-bottom: 20px;
  flex-wrap: wrap;
...
.live-dot {
  ...
  background: #E8350A; flex-shrink: 0;
  box-shadow: 0 0 0 3px rgba(232,53,10,.25);
...
.section-divider-label {
  font-size: 9px; letter-spacing: 2px; text-transform: uppercase; color: var(--text-3);
}
...
.work-icon {
  ...
  font-size: 16px; flex-shrink: 0; color: var(--text-2);
...
/* ── PILLS ────────────────────────────────────────────────────────────────── */
.pill {
  font-size: 10px; letter-spacing: .5px; padding: 2px 8px;
...
.ns-hd {
  ...
  border-bottom: .5px solid var(--border);
  background: linear-gradient(135deg, rgba(91,159,224,.06) 0%, transparent 60%);
}
...
/* ── COLOUR DIMS (used by activity avatars) ───────────────────────────────── */
:root {
...
<div class="dash-wrap">
  ...
  <div class="briefing-grid">
    <a class="brief-card brief-urgent" href="/app/tasks.php">
    ...
    <a class="brief-card" href="/app/production.php?id=gala&tab=callsheet">
    ...
    <a class="brief-card" href="/app/calendar.php">
    ...
    <div class="dash-col">
      ...
      <div class="card">
        <div class="chd">
          ...
          <div style="display:flex;gap:6px">
            <a class="btn-ghost-sm" href="/app/projects.php">Projects →</a>
            <a class="btn-ghost-sm" href="/app/productions.php">Productions →</a>
          </div>
        </div>
        <div class="section-divider"><div class="section-divider-label">Projects</div></div>
        <a class="work-row" href="/app/project.php?id=sphere">
        ...
        <a class="work-row" href="/app/project.php?id=venue">
          <div class="work-icon" style="background:var(--teal-dim)">🏗</div>
          <div class="work-info">
        ...
        <a class="work-row" href="/app/production.php?id=gala">
        ...
        <a class="work-row" href="/app/production.php?id=summit">
        ...
        <a class="work-row" href="/app/production.php?id=dinner">
      ...
      <div class="card">
        <div class="chd">
          ...
          <a class="cha" href="/app/tasks.php">View all →</a>
        </div>
        <div class="task-row">
    ...
    <div class="dash-col">
      ...
      <div class="card">
        ...
        <div class="ns-body">
          ...
          <a class="btn-outline w-full" href="/app/production.php?id=summit" style="justify-content:center;margin-top:12px;font-size:11px">Open workspace →</a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="chd">
          ...
          <a class="cha" href="/app/messages.php">All messages →</a>
        </div>
        <a class="work-row" href="/app/messages.php?chat=gala-team" style="align-items:center;background:rgba(232,184,75,.04)">
          <div class="work-icon" style="background:var(--live-dim);border-radius:8px;font-size:16px">🎭</div>
          <div class="work-info">
        ...
        <a class="work-row" href="/app/messages.php?chat=tom" style="align-items:center;background:rgba(232,184,75,.04)">
          <div class="work-icon" style="background:var(--blue-dim)">TR</div>
          <div class="work-info">
        ...
        <a class="work-row" href="/app/messages.php?chat=summit-team" style="align-items:center">
          <div class="work-icon" style="background:var(--blue-dim);border-radius:8px;font-size:16px">🎭</div>
          <div class="work-info">
        ...
        <a class="work-row" href="/app/messages.php?chat=sarah" style="align-items:center">
          <div class="work-icon" style="background:var(--live-dim)">SM</div>
          <div class="work-info">
      ...
      <div class="card">
        <div class="chd">
          ...
          <a class="cha" href="/app/calendar.php">Full calendar →</a>
        </div>
        <div class="mini-cal">
          <div class="mc-grid">
            ...
            <a class="mc-d ev" href="/app/calendar.php">12</a>
            <a class="mc-d ev" href="/app/calendar.php">13</a>
            <a class="mc-d show-day" href="/app/production.php?id=gala">14</a>
            <a class="mc-d ev" href="/app/calendar.php">15</a>
      ...
      <div class="card">
        ...
        <div class="qa-grid">
          <a class="qa-btn" href="/app/new-production.php"><div class="qa-icon">🎭</div><div class="qa-lbl">New production</div><div class="qa-sub">Start from scratch</div></a>
          <a class="qa-btn" href="/app/new-project.php"><div class="qa-icon">🏗</div><div class="qa-lbl">New project</div><div class="qa-sub">Long-term build</div></a>
          <a class="qa-btn" href="/app/production.php?id=gala&tab=ros"><div class="qa-icon">▶</div><div class="qa-lbl">Open ROS</div><div class="qa-sub">Summerset Gala · Live</div></a>
          <a class="qa-btn" href="/app/messages.php"><div class="qa-icon">💬</div><div class="qa-lbl">Messages</div><div class="qa-sub">4 unread</div></a>
        </div>
      </div>
