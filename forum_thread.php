...
$id = (int)($_GET['id'] ?? 0);
if (!$id) { header('Location: /forum.php'); exit; }
...
<div class="forum-page">
  ...
  <div class="forum-breadcrumb">
    ...
    <span>›</span>
    <a href="/forum.php?cat=<?php echo e($thread['cat_slug']); ?>"><?php echo e($thread['cat_name']); ?></a>
    <span>›</span>
  ...
  <div class="forum-layout">
    <div class="forum-main">
      ...
      <?php else: ?>
        <div class="reply-form-card" style="text-align:center;padding:32px">
          ...
          <a class="btn-gold-lg" href="/register.php">Join free →</a>
    ...
    <div class="forum-sidebar">
      ...
      <div style="padding:4px 0">
        <a class="sidebar-back" href="/forum.php?cat=<?php echo e($thread['cat_slug']); ?>">← <?php echo e($thread['cat_name']); ?></a>
        <a class="sidebar-back" href="/forum.php" style="margin-top:6px">← All categories</a>
      </div>
    </div>
  </div>
