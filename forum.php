...
<div class="forum-page">
  ...
  <div class="forum-page-hd">
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
      <a class="btn-gold-lg" href="/forum_post.php">+ New thread</a>
    <?php else: ?>
      <a class="btn-gold-lg" href="/register.php">Join free to post →</a>
    <?php endif; ?>
  </div>
    ...
    <div class="forum-main">
      ...
      <div class="forum-cats">
        <?php foreach ($cats as $c): ?>
          <a class="forum-cat-card" href="/forum.php?cat=<?php echo e($c['slug']); ?>">
      ...
      <div class="forum-section-label" style="margin-top:32px">
        ...
        <?php if ($active_cat): ?>
          <a href="/forum.php" style="font-size:11px;color:var(--text-3);margin-left:10px;font-weight:400">← All categories</a>
        <?php endif; ?>
      </div>

      <?php if (empty($thread_list)): ?>
        <div class="forum-empty">No threads yet. <a href="/forum_post.php" style="color:var(--gold)">Start one →</a></div>
      <?php else: ?>
    ...
    <div class="forum-sidebar">
      ...
      <?php if (!isset($_SESSION['user_id'])): ?>
        <div class="sidebar-card" style="padding:20px">
          ...
          <a class="btn-gold-lg" href="/register.php" style="width:100%;text-align:center;display:block;font-size:13px">Create free account →</a>
        </div>
      <?php endif; ?>
      ...
      <?php if (!empty($trending)): ?>
        <div class="sidebar-card">
          ...
          <?php foreach ($trending as $tr): ?>
            <a class="trend-row" href="/forum_thread.php?id=<?php echo $tr['id']; ?>" style="text-decoration:none">
